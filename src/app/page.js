...
const schema = z
  .object({
    ...
    password: z
      ...
      .max(12, { message: "Password must not eaceed 12 characters" }),
  ...
  .refine(
    (p) => {
      if (p.confirmPassword !== p.password) return false;
      else return true;
    },
    {
  ...
  return (
    <div>
      <Container size="500px">
        ...
        <Footer year={2023} fullName="Rawipa Samhuay" studentId="650610801" />
      </Container>
